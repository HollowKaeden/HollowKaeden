# 🌟 Обо мне:
🗿 Артамонов Иван<br>👨‍💻 Начинающий Backend разработчик на Python, студент 4 курса МИРЭА, очная форма обучения<br>💭 В данный момент изучаю структуры и алгоритмы, а также фреймворк Django
